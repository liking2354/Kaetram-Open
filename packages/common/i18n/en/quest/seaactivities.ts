export default {
    name: 'Sea Activities',
    description:
        'A mysterious being needs your help under the sea.|Venture under the sea by unlocking a secret entrance on the beach and talk to a fishy being about some underwater sea activities. If I remember correctly he may need your help with something.',
    rewards: ['1000 gold'],
    stages: {
        0: {
            text: [
            ...
            completedText: ['FIND THE SEA CUCUMBER PLEASE!']
        },
        1: {
            text: [
            ...
            completedText: ["I said I'm not giving it back, now beat it."]
        },
        2: {
            text: [
            ...
            completedText: ['Go tell him to give me my money back!']
        },
        3: {
            text: [
            ...
            completedText: ['Go through the door and fight me fair and square!']
        },
        5: {
            text: [
