export default {
    ...
    description:
        "The coder requires your help sorting out his bugs.|The coder (as you were probably told about in the tutorial if you didn't skip it), requires your help with defeating the bugs he has created. He seeks the trophy of the first three bosses.",
