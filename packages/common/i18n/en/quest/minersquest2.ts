export default {
    ...
    description:
        "The miner is at it again, this time he doesn't just need ores.|The miner requires your help once again, this time his sketch creations include bars of metals and stuff like that. You should probably go see what he's up to and whatnot.",
    ...
    stages: {
        0: {
            ...
            completedText: [
                ...
                'Bring me 5 tin bars and 5 copper bars.'
            ]
        },
        1: {
