export default {
    name: 'Desert Quest',
    description:
        'Help the dying adventurer send a letter to his wife.|The adventurer is dying and is in dire need of your help with super important matters prior to his death. You can find him in the desert.',
    ...
    stages: {
        ...
        1: {
            text: ['Hello? Why are you in my house..?'],
            completedText: ['Go on now, tell him.'],
            hasItemText: [
        ...
        2: {
            ...
            completedText: ['Farewell adventurer, this may be the last time we meet.']
        }
    }
} as const;
