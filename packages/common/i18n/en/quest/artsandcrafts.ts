export default {
    ...
    description:
        'Help the old lady on the great mountai with her crafts.|The old lady on the great mountain is very cold and needs a brave adventurer to run errands for her. In exchange you will be taught how to start crafting items.',
    ...
    stages: {
        ...
        1: {
            completedText: ['Fletch me a small bowl and bring it to me.'],
            hasItemText: [
        ...
        2: {
            completedText: ['Try making a stew using a bowl, a tomato, and the cauldron.'],
            hasItemText: [
        ...
        3: {
            hasItemText: ["Wonderful, see, you're getting the hang of it."]
        }
    }
} as const;
